<?php
    ...
    $mysql->query("UPDATE `individ_shedule` SET `id_weekday` = '$week2' AND `id_time` = '$time2' AND `id_coach` = '$coach2'
    AND `id_club` = '$club2' AND `id_sport` = '$sport2'
    WHERE `id_user`='$user' AND `id_weekday` = '$week' AND `id_time` = '$time' AND `id_coach` = '$coach'
